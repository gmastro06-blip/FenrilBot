...
class SwapRingCard(customtkinter.CTkFrame):
    def __init__(self, parent: tk.Misc, context: Any) -> None:
        ...
        self.healthFoodLabel = customtkinter.CTkLabel(self, text="Swap ring")
        ...
        self.hpLessThanOrEqualSlider.grid(column=1, row=4, sticky='ew', padx=10, pady=10)
        ...
        self.hpGreaterThanSlider.grid(column=1, row=8, sticky='ew', padx=10, pady=10)
