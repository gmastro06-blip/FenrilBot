...
class DepositItemsModal(customtkinter.CTkToplevel):
    def __init__(
        ...
        self.cityCombobox = customtkinter.CTkComboBox(
            self.frame, values=['AbDendriel', 'Ankrahmun', 'Carlin', 'Darashia', 'Edron', 'Farmine', 'Issavi', 'Kazoordon', 'LibertBay', 'PortHope', 'Rathleton', 'Svargrond', 'Thais', 'Venore', 'Yalahar', 'Feyrist', 'Dark Mansion'], state='readonly')
