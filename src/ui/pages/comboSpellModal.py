...
class ComboSpellModal(customtkinter.CTkToplevel):
    def __init__(
        ...
        self.hotkeyLabel = customtkinter.CTkLabel(self.frame, text='Hotkey:')
        self.hotkeyLabel.grid(column=0, row=2, padx=10, pady=10, sticky='w')

        self.hotkeyEntryVar = StringVar()
        self.hotkeyEntryVar.set(spell['hotkey'] if spell is not None else '')
        ...
        self.hotkeyEntry.grid(column=0, row=3, padx=10, pady=10, sticky='nsew')
        ...
        self.confirmButton.grid(row=6, column=0, padx=(10, 5), pady=(5, 10), sticky='nsew')
