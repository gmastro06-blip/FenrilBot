...
context = {
    ...
    # Default matches previous behavior (FENRIL_START_PAUSED defaulted to 1).
    # Real value is loaded from profile ng_runtime.start_paused in loadContextFromConfig.
    'ng_pause': True,
